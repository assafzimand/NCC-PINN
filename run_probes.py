"""Linear probe analysis orchestrator for trained models."""
...
def main():
    """Orchestrate linear probe analysis workflow."""
    print("=" * 60)
    print("Linear Probe Analysis Orchestrator")
    print("=" * 60)
    ...
    if not eval_only:
        # Training mode - train first, then run probes on best checkpoint
        print("\n3. Training mode - will train then run probe analysis")
        ...
        print("\n3. Evaluation-only mode - Probe analysis only")
    ...
    # Run probe analysis
    print(f"\n{'8' if not eval_only else '5'}. Running probe analysis...")
    ...
    print(f"  - probe_metrics.json")
    print("\nProbe Summary:")
    print(f"  Layers analyzed: {probe_metrics['layers_analyzed']}")
    print(f"  Final layer train Rel-L2: {probe_metrics['train']['rel_l2'][-1]:.6f}")
    print(f"  Final layer eval Rel-L2: {probe_metrics['eval']['rel_l2'][-1]:.6f}")
    print("=" * 60)
